import { createPost, formatPosts, getPosts, deletePost, updatePost } from '../../services/PostsService';
import { CONFIRMED_CREATE_POST_ACTION, CONFIRMED_DELETE_POST_ACTION, CONFIRMED_EDIT_POST_ACTION, CONFIRMED_GET_POSTS } from '../constants/post.constant';
